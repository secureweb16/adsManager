        ...
        <div class="x_content">
          ...
          <form method="post" enctype=multipart/form-data action="{{route('advertiser.campaigns.create')}}">
           ...
           <!--  <div class="item form-group">
              ...
              <div class="col-md-9 col-sm-9">                
                <textarea name="other_description" id="other_description">{{ old('other_description') }}</textarea>
...
<script>
  ...
  // $('textarea[name="other_description"]').focusout(function(){    
  //   let desc = $('#other_description').val();    
