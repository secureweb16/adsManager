<!DOCTYPE html>
<html lang="en">
@include('partials.publisher.head')
<body class="nav-md">
  <div class="container body">
    <div class="main_container">

      @include('partials.publisher.sidebar')
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{route('publisher.profile.index')}}"><i class="fa pull-right"></i> Profile</a>
              ...
              <li> Payout Balance: ${{ get_publisher_payout(Auth::user()->id) }} </li>
              @if(Auth::user()->id)
              <li> 
      ...
      <div class="right_col" role="main">
        @yield('content')
        @include('partials.publisher.popup')
      </div>
    </div>
  </div>
...
@include('partials.publisher.footer')
